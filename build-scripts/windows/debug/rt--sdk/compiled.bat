...
REM set MATLAB_PATH_64=C:\Program Files\MATLAB\R2023b
set OCTAVE_PATH_64=C:\Program Files\GNU Octave\Octave-11.1.0

set AYF_PYTHON_ENVIRONMENT=c:\develop\uv\venv-3.10.19
set PATH=%PATH%;%AYF_PYTHON_ENVIRONMENT%\Scripts\Scripts
set PYBIND_PATH="%AYF_PYTHON_ENVIRONMENT%\Lib\site-packages\pybind11\share\cmake\pybind11"
REM where python
call c:\develop\uv\venv-3.10.19\Scripts\activate

set TOKEN_SDK=-DJVX_RELEASE_SDK=FALSE
set TOKEN_BTOOLS=-DJVX_COMPILE_BUILDTOOLS=FALSE

REM Need this for the flutter builds to detect matching SDK
set AYF_SDK_PATH=%CD%\release\sdk
...
set ADDITIONAL_FEATURE_TOKENS_MIN=^
	...
	-DAYF_CONNECTION_PROTOCOL_DETAILS=true ^
