	...
	{
		return _reference_connection_process(idx, connected);
	};
	...
	{
		return _reference_connection_process_uid(uid, connected);
	};
	...
	{
		return _return_reference_connection_process(connected);
	};
	...
	{
		return _create_connection_process( nm, unique_id, interceptors, essential_for_start, verbose_out, report_global, idProcDepends);
	};

	virtual jvxErrorType JVX_CALLINGCONVENTION remove_connection_process(jvxSize unique_id) override
	{
		return _remove_connection_process(unique_id);
	};
	...
	{
		return _number_connections_group(num);
	};
	...
	{
		return _reference_connection_group(idx, connected);
	};
	...
	{
		return _reference_connection_group_uid(uid, connected);
	};
	...
	{
		return _create_connection_group( nm,  unique_id, descr, verbose_out);
	};

	virtual jvxErrorType JVX_CALLINGCONVENTION remove_connection_group(jvxSize unique_id) override
	{
		return _remove_connection_group(unique_id);
	};
	...
	{
		return _reference_connection_factory( idx, theFac, unique_id);
	};
	...
	{
		return _register_connection_master_factory(theFac);
	};
	...
	{
		return _reference_connection_master_factory(idx, theFac, unique_id);
	};
	...
	{
		return _reference_connection_master_factory_uid(unique_id, theFac);
	};
	...
	{
		return _return_reference_connection_master_factory(theFac);
	};
	...
	{
		return _number_connection_rules(num);
	};
	...
	{
		return _reference_connection_rule(idx, rule_on_return);
	};
	...
	{
		return _reference_connection_rule_uid(uId, rule_on_return);
	};
	...
	{
		return _return_reference_connection_rule(rule_to_return);
	};
	...
	*/
	...
	{
		return _uid_for_reference(ref,  uid, isProcess);
	}
