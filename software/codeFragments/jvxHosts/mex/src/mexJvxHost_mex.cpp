...
void
mexJvxHost::mexReturnStructOneProperty(mxArray*& plhs, jvxPropertyCategoryType catProperty, jvxUInt64 allowStateMask, jvxUInt64 allowThreadingMask,
	...
	jvxBool isValid, jvxFlagTag accessFlags)
{
	...
	arr = NULL;
	mexReturnString(arr, description);
	mxSetFieldByNumber(plhs, 0, 1, arr);

	arr = NULL;
	mexReturnInt32(arr, (jvxInt32)catProperty);
	mxSetFieldByNumber(plhs, 0, 2, arr);

	arr = NULL;
	mexReturnInt32(arr, (jvxInt32)hdlIdx);
	mxSetFieldByNumber(plhs, 0, 3, arr);

	arr = NULL;
	mexReturnInt32(arr, (jvxInt32)format);
	mxSetFieldByNumber(plhs, 0, 4, arr);

	arr = NULL;
	mexReturnInt32(arr, (jvxInt32)numElms);
	mxSetFieldByNumber(plhs, 0, 5, arr);

	arr = NULL;
	mexReturnInt32(arr, (jvxInt32)decHtTp);
	mxSetFieldByNumber(plhs, 0, 6, arr);

	arr = NULL;
	mexReturnInt64(arr, (jvxInt64)allowStateMask);
	mxSetFieldByNumber(plhs, 0, 7, arr);

	arr = NULL;
	mexReturnInt64(arr, (jvxInt64)allowThreadingMask);
	mxSetFieldByNumber(plhs, 0, 8, arr);

	arr = NULL;
	mexReturnInt64(arr, (jvxInt32)accessType);
	mxSetFieldByNumber(plhs, 0, 9, arr);

	arr = NULL;
	mexReturnString(arr, descriptor);
	mxSetFieldByNumber(plhs, 0, 10, arr);
	
	arr = NULL;
	mexReturnInt32(arr, (jvxInt32)context);
	mxSetFieldByNumber(plhs, 0, 11, arr);

	arr = NULL;
	mexReturnBool(arr, isValid);
	mxSetFieldByNumber(plhs, 0, 12, arr);

	arr = NULL;
	mexReturnInt32(arr, (jvxInt32)accessFlags);
	mxSetFieldByNumber(plhs, 0, 13, arr);
}

jvxErrorType
mexJvxHost::mexReturnPropertyNumerical(mxArray*& plhs, jvxSize hdlIdx, jvxPropertyCategoryType catTp, jvxDataFormat format, 
	jvxSize numElms, jvxPropertyDecoderHintType decHtTp, jvx_propertyReferenceTriple& theTriple, jvxSize offset)
{
	...
	if (res == JVX_NO_ERROR)
	{
		...
		arr = NULL;
		mexReturnInt32(arr, accessType);
		mxSetFieldByNumber(plhs, 0, 1, arr);

		arr = NULL;
		mexReturnInt32(arr, decHtTp);
		mxSetFieldByNumber(plhs, 0, 2, arr);

		arr = NULL;
		mexReturnInt32(arr, callGate.access_protocol);
		mxSetFieldByNumber(plhs, 0, 3, arr);
	}
	else
	{
...
jvxErrorType
mexJvxHost::mexReturnPropertyNumericalSize(mxArray*& plhs, jvxSize hdlIdx, jvxPropertyCategoryType catTp, jvxDataFormat format, jvxSize numElms, 
...
jvxErrorType
mexJvxHost::mexReturnPropertyNumerical(mxArray*& plhs, jvxDataFormat format, jvxSize numElms, const char* descr, jvx_propertyReferenceTriple& theTriple, jvxSize offset)
{
	jvxErrorType res = JVX_NO_ERROR;
	jvxCallManagerProperties callGate;
...
jvxErrorType
mexJvxHost::mexReturnPropertyNumericalSize(mxArray*& plhs, jvxDataFormat format, jvxSize numElms, const char* descr, jvx_propertyReferenceTriple& theTriple, jvxSize offset)
{
	jvxSize i;
	jvxErrorType res = JVX_NO_ERROR;
	jvxCallManagerProperties callGate;
...
jvxErrorType
mexJvxHost::mexReturnPropertyOthers(mxArray*& plhs, jvxSize hdlIdx, jvxPropertyCategoryType catTp, jvxDataFormat format, jvxSize numElms, 
	jvxPropertyDecoderHintType decHtTp, jvx_propertyReferenceTriple& theTriple, jvxSize offset)
{
	jvxSize i;
	jvxErrorType res = JVX_NO_ERROR;
	...
	if(numElms > 0)
	{
		...
		case JVX_DATAFORMAT_SELECTION_LIST:
			...
			if(res == JVX_NO_ERROR)
			{
				mexReturnSelectionListStruct(arr, theSelList);
			}
		...
		case JVX_DATAFORMAT_VALUE_IN_RANGE:
			...
			if(res == JVX_NO_ERROR)
			{
				mexReturnValueInRangeStruct(arr, vInRange);
			}
...
jvxErrorType
mexJvxHost::mexReturnPropertyOthers(mxArray*& plhs, jvxDataFormat format, jvxSize numElms, const char* descr, jvx_propertyReferenceTriple& theTriple, jvxSize offset)
{
	int i;
	jvxHandle* data = NULL;
	jvxErrorType res = JVX_NO_ERROR;
	...
	if(numElms > 0)
	{
		...
		case JVX_DATAFORMAT_SELECTION_LIST:
			...
			if(res == JVX_NO_ERROR)
			{
				mexReturnSelectionListStruct(plhs, theSelList);
			}
		...
		case JVX_DATAFORMAT_STRING_LIST:
			...
			if(res == JVX_NO_ERROR)
			{
				...
				mexReturnStringCell(plhs, lstTxt);
			}
		...
		case JVX_DATAFORMAT_VALUE_IN_RANGE:
			...
			if(res == JVX_NO_ERROR)
			{
				mexReturnValueInRangeStruct(plhs, vInRange);
			}
...
void
mexJvxHost::mexReturnStructProperties(mxArray*& plhs, jvx_propertyReferenceTriple& theTriple)
{
	jvxSize i;
	const char** fld = NULL;
	std::string* fldStr = NULL;
