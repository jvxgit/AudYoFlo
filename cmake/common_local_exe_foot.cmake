...
###
if(JVX_USE_TRACY)
  set(ADDITIONAL_SOURCES ${ADDITIONAL_SOURCES} ${TRACY_SOURCE_FILE})
  set(ADDITIONAL_COMPILE_DEFINITIONS ${ADDITIONAL_COMPILE_DEFINITIONS} TRACY_ENABLE)
endif()
...
if(IS_C_APP)
  ...
  if(LOCAL_C_STANDARD)
	set_property(TARGET ffmpeg PROPERTY C_STANDARD ${LOCAL_C_STANDARD})
  endif()
  ...
  if(LOCAL_CXX_STANDARD)
	set_property(TARGET ffmpeg PROPERTY CXX_STANDARD ${LOCAL_CXX_STANDARD})
  endif()
endif()
