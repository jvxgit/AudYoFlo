...
macro (find_octave)
  ...
  if(IS_DIRECTORY "${OCTAVE_PATH}")
    ...
    if(${OCTAVE_VERSION} STRLESS 10.0.0)
      message(FATAL_ERROR "Octave must be at least version 10")
    endif()
    ...
    if(OCTAVE_VERSION VERSION_GREATER "11.0.0") 
		...
		set(JVX_SYSTEM_OCTAVE_MEX_LIBRARIES ${JVX_SYSTEM_OCTAVE_MEX_LIBRARIES} "${OCTAVE_PATH_LIB}/liboctmex.so")
