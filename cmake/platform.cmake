...
if(JVX_PROFILE_TEXT_LOG_LOCK_LOCKCOUNT GREATER 0)
	set(GLOBAL_COMPILE_DEFINITIONS "${GLOBAL_COMPILE_DEFINITIONS};JVX_PROFILE_TEXT_LOG_LOCK_LOCKCOUNT=${JVX_PROFILE_TEXT_LOG_LOCK_LOCKCOUNT}")
endif()

if(JVX_FOPEN_CLOSE_VERBOSE)
	set(GLOBAL_COMPILE_DEFINITIONS "${GLOBAL_COMPILE_DEFINITIONS};JVX_FOPEN_CLOSE_VERBOSE")
endif()