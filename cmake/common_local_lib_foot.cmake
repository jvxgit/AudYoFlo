...
if (LOCAL_OCTCONF_SCRIPTS OR USES_OTHER_LOCAL_OCTCONF_SCRIPTS)
  if(JVX_USE_PART_OCTAVE)
    ...
    foreach(LOCAL_OCTCONF_SCRIPT ${LOCAL_OCTCONF_SCRIPTS})
      message("execute_process(COMMAND ${OCTAVE} -qf --no-gui --no-history ${LOCAL_OCTCONF_SCRIPT} show_filename OUTPUT_VARIABLE OUTFILE)")
      execute_process(COMMAND ${OCTAVE} -qf --no-gui --no-history ${LOCAL_OCTCONF_SCRIPT} show_filename OUTPUT_VARIABLE OUTFILE)
      string(REPLACE "\n" ";" OUTFILE ${OUTFILE})
      JVX_PREPEND(OUTFILE "${CMAKE_CURRENT_BINARY_DIR}/generated/" ${OUTFILE})
      message("      ${LOCAL_OCTCONF_SCRIPT} -> ${OUTFILE}")
      add_custom_command(
        COMMAND ${OCTAVE}
        ARGS -qf --no-gui --no-history ${LOCAL_OCTCONF_SCRIPT} ${OUTFILE} ${JVX_BASE_LIBS_MATOCT_GEN_LIB} ${LOCAL_OCTCONF_ADDITIONAL_PATHS}
        OUTPUT  ${OUTFILE}
