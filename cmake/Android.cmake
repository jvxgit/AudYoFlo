...
if(CMAKE_HOST_WIN32)
	...
	## For Windows build, we need to add a separator character at this place to enable bat processing lateron
	...
	# No seperator required on Linux
	set(ADDITIONAL_FEATURE_TOKENS_CMAKE_THIRD_PARTY 
		"-DCMAKE_TOOLCHAIN_FILE=${CMAKE_TOOLCHAIN_FILE} -DANDROID_ABI=${ANDROID_ABI} -DANDROID_NDK=${ANDROID_NDK} -DANDROID_API_VERSION=${ANDROID_API_VERSION} -DANDROID_PLATFORM=${ANDROID_PLATFORM} -DCMAKE_ANDROID_ARCH_ABI=${CMAKE_ANDROID_ARCH_ABI} -DCMAKE_ANDROID_NDK=${CMAKE_ANDROID_NDK} -DCMAKE_SYSTEM_NAME=${CMAKE_SYSTEM_NAME} -DCMAKE_SYSTEM_VERSION=${CMAKE_SYSTEM_VERSION}")
endif()
...
if (JVX_USE_PART_ASIO)
  message("XX> deactivating ASIO support (not supported on Android)")
  set(JVX_USE_PART_ASIO OFF)
endif()
if (JVX_USE_PART_CORECONTROL)
  message("XX> deactivating corecontrol support (not supported on Android)")
  set(JVX_USE_PART_CORECONTROL OFF)
endif()
if (JVX_USE_PART_ALSA)
  message("XX> deactivating alsa audio support (not supported on Android)")
  set(JVX_USE_PART_ALSA OFF)
endif()
if (JVX_USE_PART_COREAUDIO)
  message("XX> deactivating core audio support (not supported on Android)")
  set(JVX_USE_PART_COREAUDIO OFF)
endif()
if (JVX_USE_PART_PAUDIO)
  message("XX> deactivating portaudio support (not supported on Android)")
