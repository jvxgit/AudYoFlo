...
#	message("exec_program(\"${JVX_PCG_MATLAB} ${PCGFILE} -o ${CMAKE_CURRENT_BINARY_DIR}/m-files/+${targetname} -ctp ${componenttype} -cpf ${componentprefix}\")")
	...
	string(REPLACE ";" " " localoptions "${LOCAL_PCG_FILE_OPTIONS}")

	# Added some quotes for systems with spaces in path
	install(CODE "exec_program(\"${JVX_PCG_MATLAB} \\\"${PCGFILE}\\\" -o \\\"${CMAKE_CURRENT_BINARY_DIR}/m-files/+${targetname_tweaked}\\\" -ctp ${componenttype} -cpf ${componentprefix} ${localoptions}\")")
  endforeach()
