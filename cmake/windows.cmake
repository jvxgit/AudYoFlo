...
if (JVX_USE_PART_ANDROIDAUDIO)
  # message("XX> deactivating android audio support (not supported on Windows)")
  # set(JVX_USE_PART_ANDROIDAUDIO false)  
endif()
...
if(JVX_BUILD_FOR_WINDOWS_XP)
	set(GLOBAL_COMPILE_DEFINITIONS "${GLOBAL_COMPILE_DEFINITIONS};OLDER_THAN_WINDOWS7")
endif()
...
if(JVX_WINDOWS_EXCLUDE_ATL_PROJECTS)
	set(GLOBAL_COMPILE_DEFINITIONS "${GLOBAL_COMPILE_DEFINITIONS};JVX_WINDOWS_EXCLUDE_ATL_PROJECTS")
endif()

if(JVX_ADDITIONAL_SYSTEM_INCLUDE_HEADER)
	set(GLOBAL_COMPILE_DEFINITIONS "${GLOBAL_COMPILE_DEFINITIONS};JVX_ADDITIONAL_SYSTEM_INCLUDE_HEADER=${JVX_ADDITIONAL_SYSTEM_INCLUDE_HEADER}")
endif()
...
macro (find_matlab arg1)
  ...
  if(IS_DIRECTORY "${MATLAB_PATH}")
    ...
    if(JVX_PLATFORM MATCHES "32bit")
	  ...
	  set(MATLAB_RUNTIME_LIB_PATH "${MATLAB_PATH}/bin/win64/")
    endif()
...
macro (find_octave arg1)
  ...
  if(IS_DIRECTORY "${OCTAVE_BIN_PATH}")
    ...
    exec_program("${OCTAVE_PATH_CONFIG}/bin/octave-config" ARGS "-p OCTINCLUDEDIR" OUTPUT_VARIABLE Octave_INCLUDE_DIRS)
