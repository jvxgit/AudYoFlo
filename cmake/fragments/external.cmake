...
if(NOT JVX_USE_PART_MATLAB)
	if(JVX_USE_SIMULINK)
		if(${JVX_FIND_ERR} MATCHES "FATAL")
			message(FATAL_ERROR "XX> could not find Simulink, option must be deactivated manually to procede.")			
		else()
			message("XX> could not find Simulink, option is deactivated - no Matlab modules will be built.")
			set(JVX_USE_SIMULINK FALSE)
		endif()
	endif()
endif()

# message(FATAL_ERROR "Stop hier!")
