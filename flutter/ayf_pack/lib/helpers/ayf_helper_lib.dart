...
// Field to specify an area with a min and a max value that defines a certain text input/output
class AudYoFloOneAreaTextInOut {
  final double minVal;
  final double maxVal;
  final double val;
  String textReplace = 'invalid';
  AudYoFloOneAreaTextInOut(
      {this.minVal = -double.infinity,
      this.maxVal = 0,
      this.val = -1,
      this.textReplace = "infty"});
}
...
class AudYoFloHelper {
  static int hexStringToFnInt32(resultParseInt32 result, String inStr) {
  ...
  static String? getStringEntryValueMap(Map valueMap, String nm) {
    String? retVal;
    MapEntry? entry =
  ...
  static int getIntEntryValueMap(Map valueMap, String nm) {
    int retVal = -1;
    MapEntry? entry =
        valueMap.entries.firstWhereOrNull((element) => element.key == nm);
    if (entry != null) {
  ...
  static List? getListValueMap(Map valueMap, String nm) {
    List? retVal;
    MapEntry? entry =
        valueMap.entries.firstWhereOrNull((element) => element.key == nm);
    if (entry != null) {
  ...
  static Map? getMapValueMap(Map valueMap, String nm) {
    Map? retVal;
    MapEntry? entry =
        valueMap.entries.firstWhereOrNull((element) => element.key == nm);
    if (entry != null) {
  ...
  static List? getMapValueList(Map valueMap, String nm) {
    List? retVal;
    MapEntry? entry =
        valueMap.entries.firstWhereOrNull((element) => element.key == nm);
    if (entry != null) {
  ...
  static List<String> str2PropList(String ident) {
    List<String> onRet = [];
  ...
  static List<JvxCpIdPlusProp> str2PropListWithComponent(
  ...
  static String intValueList2String(List<int> lst) {
    String txt = '';
    for (int val in lst) {
      if (!txt.isEmpty) {
        txt += ', ';
  ...
  static void applyChangeSelectionList(AudYoFloBitField selection, int posi,
  ...
  static void setValueSelectionList(AudYoFloBitField selection, int posi,
  ...
  static void incrementSelectionList(AudYoFloBitField selection, int numOptions,
      jvxPropertyDecoderHintTypeEnum decTp,
      {int offset = 0}) {
...
// =======================================================================
  ...
  static void decodeInputOutputChannel(
...
// ========================================================================
  ...
  static void decodeDeviceChannel(
  ...
  static String limitString(String txt, int numCharsMax,
  ...
  static AudYoFloPropertyContentBackend? pList2Elm(
  ...
  static bool setSinglePropertyValueMulti<T>(
  ...
  static bool setAllPropertyValueMulti<T>(AudYoFloPropertyContainer mc, T val) {
    bool retVal = false;
    if (mc is AudYoFloPropertyMultiContentBackend<Float64List>) {
      AudYoFloPropertyMultiContentBackend<Float64List> pp =
          mc as AudYoFloPropertyMultiContentBackend<Float64List>;
...
// check the AudYoFloValRef type)
  static bool getSinglePropertyValueMulti<T>(
  ...
  static bool propertyValueMultiFromString(
      AudYoFloPropertyMultiContentBackend prop, String txt,
      {int offset = 0,
      int num = -1,
      List<AudYoFloOneAreaTextInOut> lstText = const []}) {
    bool suc = false;
    int idx = 0;
    ...
    if (prop is AudYoFloPropertyMultiContentBackend<Float64List>) {
      ...
      if (propM.fld != null) {
        for (idx = 0; idx < cntMax; idx++) {
          ...
          for (var elm in lstText) {
            if (elm.textReplace == lstEntries[idx]) {
              val = elm.val;
          ...
          if (!translationDone) {
            try {
              val = double.parse(lstEntries[idx]);
            } on FormatException {
              dbgPrint('Format Exception parsing ${lstEntries[idx]}.');
              break;
            }
          }
          propM.fld![idx + offset] = val;
          suc = true;
        }
      }
  ...
  static String? extractStringFromJson(Map jsonMap, String nm) {
    String? retStrPtr = getStringEntryValueMap(jsonMap, nm);
    return retStrPtr;
  }

  static Future<List<AudYoFloOneComponentSelectionOption>?>
  ...
  static void dbgPrint(String output,
      {String intro = '', int stackTraceLevel = 1}) {
    String strace = '';
    String introtoken = '';
  ...
  static JvxComponentIdentification widgetConfigCpId(
  ...
  static void widgetConfigCpIdShow(Map<String, String> entriesCfgWidgets,
  ...
  static void widgetConfigCpIdShowTD(Map<String, String> entriesCfgWidgets,
  ...
  static List<double> propertyMultiContentToDoubleList(
  ...
  static String propertyStringBackSlashes(String inVar) {
    inVar = inVar.replaceAll(r'\', '\\\\');
    return inVar;
  }

  static void mapUpdateNoHash<T1, T2>(
