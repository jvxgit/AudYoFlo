...
class AudioYoFloNative {
  ...
  late final _ffi_host_initializePtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(
              ...
              ffi.Int64,
              ffi.Int32)>>('ffi_host_initialize');
  late final _ffi_host_initialize = _ffi_host_initializePtr.asFunction<
      int Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Pointer<ffi.Int8>>,
  ...
  int ffi_req_command_decode_sswitch(
    ffi.Pointer<ffi.Void> hdl_class,
    ffi.Pointer<ffi.Int32> sswitchRet,
  ) {
  ...
  late final _ffi_req_command_decode_sswitchPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(ffi.Pointer<ffi.Void>,
              ffi.Pointer<ffi.Int32>)>>('ffi_req_command_decode_sswitch');
  ...
  late final _ffi_req_command_decode_broadcastPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(ffi.Pointer<ffi.Void>,
              ffi.Pointer<ffi.Int32>)>>('ffi_req_command_decode_broadcast');
  ...
  late final _ffi_req_command_decode_uidPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(ffi.Pointer<ffi.Void>,
              ffi.Pointer<ffi.Int64>)>>('ffi_req_command_decode_uid');
  late final _ffi_req_command_decode_uid =
      _ffi_req_command_decode_uidPtr.asFunction<
          int Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Int64>)>();

  int ffi_req_command_decode_request_type(
    ffi.Pointer<ffi.Void> hdl_class,
    ffi.Pointer<ffi.Int32> reqRetPtr,
  ) {
  ...
  late final _ffi_req_command_decode_request_typePtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(ffi.Pointer<ffi.Void>,
              ffi.Pointer<ffi.Int32>)>>('ffi_req_command_decode_request_type');
  late final _ffi_req_command_decode_request_type =
      _ffi_req_command_decode_request_typePtr.asFunction<
          int Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Int32>)>();

  ffi.Pointer<ffi.Int8> ffi_req_command_decode_ident_allocate_char_array(
    ffi.Pointer<ffi.Void> hdl_class,
  ) {
  ...
  late final _ffi_process_handle_for_uidPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<one_process> Function(
              ffi.Pointer<ffi.Void>, ffi.Int32)>>('ffi_process_handle_for_uid');
  ...
  late final _ffi_process_iterator_nextPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<ffi.Void> Function(ffi.Pointer<ffi.Void>,
              ffi.Pointer<ffi.Void>, ffi.Int64)>>('ffi_process_iterator_next');
  ...
  ffi.Pointer<ffi.Int8> ffi_process_decode_iterator_module(
    ffi.Pointer<ffi.Void> opaque_hdl,
    ffi.Pointer<ffi.Void> it_handle,
  ) {
  ...
  ffi.Pointer<ffi.Int8> ffi_process_decode_iterator_connector(
    ffi.Pointer<ffi.Void> opaque_hdl,
    ffi.Pointer<ffi.Void> it_handle,
  ) {
  ...
  late final _ffi_sequencer_startPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(
              ffi.Pointer<ffi.Void>, ffi.Int32)>>('ffi_sequencer_start');
  ...
  late final _ffi_properties_descriptor_property_linPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<one_property_full_plus> Function(
              ...
              ffi.Int32,
              ffi.Int32)>>('ffi_properties_descriptor_property_lin');
  ...
  late final _ffi_properties_get_string_listPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<one_property_string_list> Function(
              ...
              ffi.Pointer<ffi.Int8>,
              ffi.Int32,
              ffi.Int32)>>('ffi_properties_get_string_list');
  ...
  late final _ffi_properties_get_selection_listPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<one_property_string_list> Function(
              ...
              ffi.Pointer<jvxUInt32>,
              ffi.Uint64,
              ffi.Uint64)>>('ffi_properties_get_selection_list');
  ...
  late final _ffi_properties_get_content_property_fldPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(
              ...
              ffi.Pointer<ffi.Void>,
              ffi.Int32,
              ffi.Uint64)>>('ffi_properties_get_content_property_fld');
  ...
  ffi.Pointer<ffi.Int8> ffi_properties_get_string(
    ffi.Pointer<ffi.Void> opaque_hdl,
    ffi.Pointer<one_property_comp> opaque_prop,
    ffi.Pointer<ffi.Int8> desror,
  ) {
  ...
  late final _ffi_properties_get_string =
      _ffi_properties_get_stringPtr.asFunction<
          ffi.Pointer<ffi.Int8> Function(ffi.Pointer<ffi.Void>,
              ffi.Pointer<one_property_comp>, ffi.Pointer<ffi.Int8>)>();
  ...
  late final _ffi_properties_get_value_in_rangePtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<one_property_value_in_range> Function(
              ...
              ffi.Uint64,
              ffi.Pointer<ffi.Void>,
              ffi.Uint64)>>('ffi_properties_get_value_in_range');
  ...
  late final _ffi_properties_set_selection_listPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(
              ...
              ffi.Uint64,
              ffi.Uint64,
              ffi.Int32)>>('ffi_properties_set_selection_list');
  ...
  late final _ffi_properties_set_value_rangePtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(
              ...
              ffi.Double,
              ffi.Double,
              ffi.Int32)>>('ffi_properties_set_value_range');
  ...
  late final _ffi_properties_set_single_stringPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(
              ...
              ffi.Pointer<ffi.Int8>,
              ffi.Pointer<ffi.Int8>,
              ffi.Int32)>>('ffi_properties_set_single_string');
  ...
  late final _ffi_properties_string_to_arrayPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(
              ...
              ffi.Int32,
              ffi.Int32,
              ffi.Int32)>>('ffi_properties_string_to_array');
  late final _ffi_properties_string_to_array =
      _ffi_properties_string_to_arrayPtr.asFunction<
          int Function(
              ffi.Pointer<ffi.Int8>, ffi.Pointer<ffi.Void>, int, int, int)>();

  ffi.Pointer<ffi.Int8> ffi_component_description(
    ffi.Pointer<ffi.Void> opaque_hdl,
  ...
  late final _ffi_component_capabilities_devicePtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<device_capabilities> Function(
              ...
              ffi.Int32)>>('ffi_component_capabilities_device');
  ...
  late final _ffi_component_selection_optionPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<selection_option> Function(
              ffi.Pointer<ffi.Void>,
              ffi.Pointer<component_ident>,
              ffi.Int32)>>('ffi_component_selection_option');
  ...
  late final _ffi_select_componentPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<component_ident> Function(
              ...
              ffi.Int32,
              ffi.Int32,
              ffi.Uint64)>>('ffi_select_component');
  ...
  int ffi_get_compile_flags(
    ffi.Pointer<ffi.Void> opaque_hdl,
    ffi.Pointer<ffi.Int32> dataTpFormat,
    ffi.Pointer<ffi.Int32> num32BitWordsSelection,
  ) {
  ...
  late final _ffi_get_compile_flagsPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Int32>,
              ffi.Pointer<ffi.Int32>)>>('ffi_get_compile_flags');
  ...
  late final _ffi_set_operation_flagsPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(ffi.Pointer<ffi.Void>, ffi.Int32,
              ffi.Int32)>>('ffi_set_operation_flags');
  ...
  int ffi_translate_enum_string(
    ...
    ffi.Pointer<ffi.Int8> typeSelect,
  ) {
  ...
  late final _ffi_translate_enum_stringPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Int8>,
              ffi.Pointer<ffi.Int8>)>>('ffi_translate_enum_string');
  ...
  late final _ffi_preload_dllPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(ffi.Pointer<ffi.Pointer<ffi.Void>>,
              ffi.Pointer<ffi.Int8>)>>('ffi_preload_dll');
  late final _ffi_preload_dll = _ffi_preload_dllPtr.asFunction<
      int Function(
          ffi.Pointer<ffi.Pointer<ffi.Void>>, ffi.Pointer<ffi.Int8>)>();
  ...
  late final _ffi_host_request_command_fwdPtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Void>,
              ffi.Int32)>>('ffi_host_request_command_fwd');
  ...
  ffi.Pointer<ffi.Int8> ffi_transfer_command(
    ffi.Pointer<ffi.Void> opaque_hdl,
  ...
  late final _ffi_transfer_commandPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<ffi.Int8> Function(ffi.Pointer<ffi.Void>,
              ffi.Pointer<ffi.Int8>, ffi.Int32)>>('ffi_transfer_command');
  late final _ffi_transfer_command = _ffi_transfer_commandPtr.asFunction<
      ffi.Pointer<ffi.Int8> Function(
          ffi.Pointer<ffi.Void>, ffi.Pointer<ffi.Int8>, int)>();

  ffi.Pointer<ffi.Int8> ffi_encode_component_identification(
    int cpTp,
    int slotid,
    int slotsubid,
  ) {
  ...
  late final _ffi_encode_component_identificationPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<ffi.Int8> Function(ffi.Int32, ffi.Int32,
              ffi.Int32)>>('ffi_encode_component_identification');
  ...
  late final _ffi_last_errorPtr =
      _lookup<ffi.NativeFunction<ffi.Int32 Function()>>('ffi_last_error');
  ...
  late final _ffi_host_deletePtr = _lookup<
      ffi.NativeFunction<
          ffi.Int32 Function(
              ffi.Pointer<ffi.Void>, ffi.Int32)>>('ffi_host_delete');
  ...
  late final _ffi_simple_callPtr =
      _lookup<ffi.NativeFunction<ffi.Int32 Function()>>('ffi_simple_call');
  late final _ffi_simple_call =
      _ffi_simple_callPtr.asFunction<int Function()>();
}

abstract class ffiCallbackIds {
  static const int JVX_FFI_CALLBACK_ASYNC_REPORT_TEXT = 0;
  static const int JVX_FFI_CALLBACK_SYNC_REPORT_INTERNALS_CHANGED = 1;
  static const int JVX_FFI_CALLBACK_ASYNC_REPORT_COMMAND_REQUEST = 2;
  static const int JVX_FFI_CALLBACK_REQUEST_COMMAND = 3;
}

abstract class ffiDeleteDatatype {
  static const int JVX_DELETE_DATATYPE_ASYNC_CALLBACK = 0;
  static const int JVX_DELETE_DATATYPE_CHAR_ARRAY = 1;
  static const int JVX_DELETE_DATATYPE_INTERNAL_CHANGED = 2;
  static const int JVX_DELETE_DATATYPE_REQUEST_COMMAND = 3;
  static const int JVX_DELETE_DATATYPE_ONE_PROCESS = 4;
  static const int JVX_DELETE_DATATYPE_ONE_PROP_HANDLER = 5;
  static const int JVX_DELETE_DATATYPE_ONE_SEQ_EVENT = 6;
  static const int JVX_DELETE_DATATYPE_ONE_COMPONENT_IDENT = 7;
  static const int JVX_DELETE_DATATYPE_ONE_PROPERTY_DESCRIPTOR_FULL_PLUS = 8;
  static const int JVX_DELETE_DATATYPE_PROCESS_READY = 9;
  static const int JVX_DELETE_DATATYPE_PROPERTY_STRING_LIST = 10;
  static const int JVX_DELETE_DATATYPE_DEVICE_CAPS = 11;
  static const int JVX_DELETE_DATATYPE_SELECTION_OPTION = 12;
  static const int JVX_DELETE_DATATYPE_SS_LIST = 13;
  static const int JVX_DELETE_DATATYPE_VALUE_IN_RANGE = 14;
}

class one_property_min extends ffi.Struct {
  @ffi.Int32()
...
class one_property_core extends ffi.Struct {
...
class one_property_control extends ffi.Struct {
...
class one_property_full extends ffi.Struct {
  ...
  external ffi.Pointer<ffi.Int8> descriptor;
}

class one_property_full_plus extends ffi.Struct {
...
class component_ident extends ffi.Struct {
  @ffi.Int32()
  external int tp;
...
class report_internal_changed extends ffi.Struct {
...
class retOpaqueHandle extends ffi.Struct {
  @ffi.Int32()
...
class report_callback extends ffi.Struct {
  @ffi.Int32()
...
class one_process extends ffi.Struct {
  @ffi.Int32()
  external int uId;
...
class one_property_comp extends ffi.Struct {
...
class one_sequencer_event extends ffi.Struct {
  @ffi.Int32()
...
class process_ready extends ffi.Struct {
  @ffi.Int32()
  external int err;

  external ffi.Pointer<ffi.Int8> reason_if_not;
}

class func_pointers extends ffi.Struct {
  external ffi.Pointer<
          ffi.NativeFunction<ffi.Int32 Function(ffi.Pointer<report_callback>)>>
      cb_sync;
}

class one_property_string_list extends ffi.Struct {
  @ffi.Int32()
  external int nEntries;

  external ffi.Pointer<ffi.Pointer<ffi.Int8>> pEntries;
}

class device_capabilities extends ffi.Struct {
  external ffi.Pointer<ffi.Int8> description;
...
class selection_option extends ffi.Struct {
  external ffi.Pointer<ffi.Int8> description;

  external ffi.Pointer<ffi.Int8> descriptor;
}

class ss_list extends ffi.Struct {
  external ffi.Pointer<ffi.Int32> slots;

  external ffi.Pointer<ffi.Int32> subslots;

  @ffi.Int32()
  external int num;
}

class one_property_value_in_range extends ffi.Struct {
  @ffi.Double()
