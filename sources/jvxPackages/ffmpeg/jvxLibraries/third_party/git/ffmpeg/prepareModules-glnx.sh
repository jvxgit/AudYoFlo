...
if [ -d $folder ]; then
	...
	if [ ! -d "lib" ]; then
		...
		echo ./configure --enable-shared --disable-static --disable-bzlib --enable-pic --extra-cflags="-fPIC" --disable-libdrm --disable-sndio --enable-gpl --enable-libx264 --enable-libx265 --disable-x86asm --prefix=./
		./configure --enable-shared --disable-static --disable-bzlib --enable-pic --extra-cflags="-fPIC" --disable-libdrm --disable-sndio --enable-gpl --enable-libx264 --enable-libx265 --disable-x86asm --prefix=./
