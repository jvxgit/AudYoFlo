...
AudYoFloSettingsConfigurationSection anotherSection =
        AudYoFloSettingsConfigurationSection();

    anotherSection = AudYoFloSettingsConfigurationSection();
    anotherSection.nameEntry = 'Config';

    AudYoFloOneComponentSettingsLocal addThisLocal =
        AudYoFloOneComponentSettingsLocal(
            'compTag',
            [propTestme], 
            propTags: [
    ...
    anotherSection.addEntry(addThisLocal);
  settingsConfigure.allSections[anotherSection.nameEntry] = anotherSection;
  ...
  int reportSetProperty(AudYoFloPropertyContentLocal prop) {
    ...
    if (prop.descriptor == "/settings/testme") {
      ...
      platformSpec!.triggerClose();// platformSpec!.theBeCache)
