...
std::string ayfcorepack::AyfcorepackPlugin::fileNameModule = "not-defined";
...
BOOL WINAPI DllMain(HINSTANCE hInst, DWORD dwReason, LPVOID /*lpvReserved*/)
{
    if (dwReason == DLL_PROCESS_ATTACH)
    {
        ...
        if (GetModuleFileNameA(hInst, fName, MAX_PATH) > 0)
        {
            ayfcorepack::AyfcorepackPlugin::fileNameModule = fName;
        }
    }
