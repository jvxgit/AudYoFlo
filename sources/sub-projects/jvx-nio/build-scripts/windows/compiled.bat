...
set ADDITIONAL_FEATURE_TOKENS=-DJVX_USE_VIDEO=TRUE -DJVX_USE_BOOST=TRUE -DJVX_USE_EIGEN=TRUE -DJVX_DEPLOY_EXAMPLES=TRUE -DJVX_USE_PART_WEBSERVER=TRUE

set JVX_GENERATOR_TOKEN_BT="Ninja"
set JVX_GENERATOR_TOKEN="Visual Studio 15 2017 Win64"
