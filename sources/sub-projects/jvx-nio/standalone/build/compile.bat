...
REM ============================================
cmake -DCMAKE_BUILD_TYPE=Debug .. -G %JVX_GENERATOR_TOKEN% -Wno-dev -DJVX_SDK_RUNTIME_PATH=%JVX_SDK_PATH%/runtime -DJVX_SDK_PATH=%JVX_SDK_PATH%/sdk -DJVX_MATLAB_PROPERTY_GENERATOR=TRUE 
