...
CjvxAuNNtaskLog::activate()
{
	...
	if (res == JVX_NO_ERROR)
	{
		jvxErrorType resL = logWriter_main_signal.lfc_activate(static_cast<CjvxProperties*>(this), _common_set_min.theHostRef, "main_log", 100, 500);
...
jvxErrorType
CjvxAuNNtaskLog::prepare_connect_icon_id(jvxLinkDataDescriptor* theData_in, jvxLinkDataDescriptor* theData_out, jvxSize idCtxt,
	CjvxOutputConnectorNtask* refto JVX_CONNECTION_FEEDBACK_TYPE_A(fdb))
{
	jvxErrorType resL = JVX_NO_ERROR;
	jvxErrorType res = JVX_ERROR_UNSUPPORTED;

	res = CjvxAuNTasks::prepare_connect_icon_id(theData_in, theData_out, idCtxt, refto JVX_CONNECTION_FEEDBACK_CALL_A(fdb));
...
jvxErrorType
CjvxAuNNtaskLog::postprocess_connect_icon_id(jvxLinkDataDescriptor* theData_in, jvxLinkDataDescriptor* theData_out, jvxSize idCtxt,
	CjvxOutputConnectorNtask* refto JVX_CONNECTION_FEEDBACK_TYPE_A(fdb))
{
	jvxErrorType res = JVX_ERROR_UNSUPPORTED;
	jvxErrorType resL = JVX_NO_ERROR;
	...
	res = CjvxAuNTasks::postprocess_connect_icon_id(theData_in, theData_out, idCtxt, refto JVX_CONNECTION_FEEDBACK_CALL_A(fdb));
...
jvxErrorType
CjvxAuNNtaskLog::process_buffers_icon_id(jvxLinkDataDescriptor* theData_in,
	...
	jvxSize mt_mask, jvxSize idx_stage)
{
	...
	res = CjvxAuNTasks::process_buffers_icon_id(
		theData_in,
		theData_out,
		idCtxt,
		refto,
...
{
	jvxErrorType res = CjvxNBareNtask::get_configuration(callConf, processor, sectionWhereToAddAllSubsections);
...
jvxErrorType 
CjvxAuNNtaskLog::set_property(jvxCallManagerProperties* callGate,
	jvxHandle* fld,
	jvxSize numElements,
	...
	jvxBool contentOnly)
{
	jvxErrorType res = CjvxNBareNtask::set_property(
		callGate, 
		fld,
		numElements,
		format,
	...
	if (res == JVX_NO_ERROR)
	{
		res = logWriter_main_signal.lfc_set_property(fld,
			numElements,
			format,
			propId,
			category,
...
jvxErrorType
CjvxAuNNtaskm::prepare_connect_icon_id(jvxLinkDataDescriptor* theData_in, jvxLinkDataDescriptor* theData_out, jvxSize idCtxt,
	CjvxOutputConnectorNtask* refto JVX_CONNECTION_FEEDBACK_TYPE_A(fdb))
{
	jvxErrorType res = JVX_ERROR_UNSUPPORTED;
...
jvxErrorType
CjvxAuNNtaskm::postprocess_connect_icon_id(jvxLinkDataDescriptor* theData_in, jvxLinkDataDescriptor* theData_out, jvxSize idCtxt,
	CjvxOutputConnectorNtask* refto JVX_CONNECTION_FEEDBACK_TYPE_A(fdb))
{
	jvxErrorType res = JVX_ERROR_UNSUPPORTED;
