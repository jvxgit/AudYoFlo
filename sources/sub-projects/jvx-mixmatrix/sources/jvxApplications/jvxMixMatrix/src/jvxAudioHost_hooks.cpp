#include "jvx.h"
#include "jvxAuNMixMatrix.h"

#define JVX_ALGO_DESCRIPTION "Mix Matrix"
#define JVX_ALGO_INIT_FUNC jvxAuNMixMatrix_init
#define JVX_ALGO_TERMINATE_FUNC jvxAuNMixMatrix_terminate
	...
	jvxErrorType jvx_configure_factoryhost_features(configureFactoryHost_features* features)
{
	...
	if (theFeaturesA)
	{
		...
		theFeaturesA->config_ui.minHeightWindow = JVX_MAX(theFeaturesA->config_ui.minHeightWindow, 760);
