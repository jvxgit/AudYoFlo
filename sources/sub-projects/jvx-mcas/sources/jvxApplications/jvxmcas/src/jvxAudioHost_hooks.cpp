#include "jvx.h"
#include "jvxAuNMcas.h"

#define JVX_ALGO_DESCRIPTION "mcas"
#define JVX_ALGO_INIT_FUNC jvxAuNMcas_init
#define JVX_ALGO_TERMINATE_FUNC jvxAuNMcas_terminate
	...
	jvxErrorType jvx_configure_factoryhost_features(configureFactoryHost_features* features)
{
	...
	if(theFeaturesA)
	{
		theFeaturesA->hideHostStartButton = true;
		theFeaturesA->disableSaveFunction = false;
		theFeaturesA->acceptSpaceStart = false;
