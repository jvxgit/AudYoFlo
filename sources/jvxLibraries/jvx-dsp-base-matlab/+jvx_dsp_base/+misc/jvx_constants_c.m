function [success] = jvx_constants_c(directory, fName, prefix, varargin)
...
if(fileH ~= -1)
    ...
    for(indV = 1:numVariables)
        ...
        if(dimy == 1) && (dimx == 1)
            ...
            fprintf(fileH, ['static DATATYPE_ARITHMETIC_USED ' prefix '_' nameVar ' = CONVERT_DOUBLE_2_DATATYPE_ARITHMETIC_USED(%.20f);\n'], var);
            fprintf(fileH, '\n');
        elseif(dimy == 1)
            ...
            for(ind2 = 1:dimx)
                ...
                fprintf(fileH, 'CONVERT_DOUBLE_2_DATATYPE_ARITHMETIC_USED(%.20f)', var(ind2));
            end
            fprintf(fileH, ['};\n']);
            fprintf(fileH, '\n');
        else
            ...
            for(ind = 1:dimy)
                ...
                for(ind2 = 1:dimx)
                    ...
                    fprintf(fileH, 'CONVERT_DOUBLE_2_DATATYPE_ARITHMETIC_USED(%.20f)', var(ind, ind2));
                end
                fprintf(fileH, ['};\n']);
            end
