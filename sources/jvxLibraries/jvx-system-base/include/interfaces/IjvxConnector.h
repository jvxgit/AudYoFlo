...
public:
	...
	virtual jvxErrorType JVX_CALLINGCONVENTION accepts_data_format_group(jvxDataFormatGroup grp) = 0;
...
public:
	...
	virtual jvxErrorType JVX_CALLINGCONVENTION outputs_data_format_group(jvxDataFormatGroup grp) = 0;
