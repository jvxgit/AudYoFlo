...
public:
	...
	virtual jvxErrorType JVX_CALLINGCONVENTION attach_external_component(IjvxObject* toBeAttached, const char* moduleGroup, jvxBool regConnFactory, jvxBool noCfgSave = true) = 0;
