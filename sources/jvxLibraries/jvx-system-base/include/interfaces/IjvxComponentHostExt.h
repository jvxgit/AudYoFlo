...
public:
	...
	virtual jvxErrorType JVX_CALLINGCONVENTION attach_external_component(IjvxObject* toBeAttached, const char* moduleGroup, const char* registerToken, jvxBool regConnFactory, jvxBool noCfgSave = true, jvxSize desiredSlotId = JVX_SIZE_DONTCARE, jvxSize desiredSlotSubId = 0) = 0;
