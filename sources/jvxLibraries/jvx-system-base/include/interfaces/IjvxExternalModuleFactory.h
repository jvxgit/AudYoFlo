...
JVX_INTERFACE IjvxExternalModuleFactory
{
 public:
  virtual JVX_CALLINGCONVENTION ~IjvxExternalModuleFactory(){};
	...
	virtual jvxErrorType JVX_CALLINGCONVENTION invite_load_components_active() = 0;
	virtual jvxErrorType JVX_CALLINGCONVENTION finalize_unload_components_active() = 0;
};
