...
public:
	...
	virtual jvxErrorType JVX_CALLINGCONVENTION postMessageExternal(const char* message, external_if_message_type tp = external_if_message_type::external_if_warning) = 0;
