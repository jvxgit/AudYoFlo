...
typedef enum 
{
	JVX_GENERIC_RS232_NO_MESSAGE_TYPE,
	JVX_GENERIC_RS232_GENERIC_MESSAGE,
	JVX_GENERIC_RS232_MESSAGE_OFFSET
}jvxGenericRs232MessageType;

typedef enum 
{
	JVX_GENERIC_RS232_STATUS_NONE,
	JVX_GENERIC_RS232_STATUS_INIT,
	JVX_GENERIC_RS232_STATUS_SENT,
	JVX_GENERIC_RS232_STATUS_RESPONDED,
	JVX_GENERIC_RS232_STATUS_RETRANSMIT
} jvxLaRs232MessageStatus;

struct oneMessage_hdr
{
	jvxBool expectResponse;
	jvxSize tp; /* jvxGenericRs232MessageType */
	jvxLaRs232MessageStatus stat;
	jvxSize uId;
	jvxSize mId;
	jvxSize sz_elm;
