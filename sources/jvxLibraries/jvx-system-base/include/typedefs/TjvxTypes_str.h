...
static jvxTextHelpers jvxSequencerElementType_str[JVX_SEQUENCER_TYPE_COMMAND_LIMIT] =
{
	...
	{"output text", "JVX_SEQUENCER_TYPE_OUTPUT_TEXT"}, // JVX_SEQUENCER_TYPE_COMMAND_OUTPUT_TEXT
	{"call seq", "JVX_SEQUENCER_TYPE_CALL_SEQUENCE"}, // JVX_SEQUENCER_TYPE_COMMAND_CALL_SEQUENCE
...
static jvxTextHelpers jvxReportCommandRequest_str[(int)jvxReportCommandRequest::JVX_REPORT_COMMAND_REQUEST_LIMIT] =
{
	...
	{"cmdreq-req-upd-prop-cnt", "JVX_REPORT_COMMAND_REQUEST_UPDATE_PROPERTY_CONTENT"},
	{"cmdreq-req-upd-prop-cnt-descr", "JVX_REPORT_COMMAND_REQUEST_UPDATE_PROPERTY_DESCRIPTOR_CONTENT"},
	{"cmdreq-req-prop-set", "JVX_REPORT_COMMAND_REQUEST_PROPERTY_REPORT_SET"}
};
