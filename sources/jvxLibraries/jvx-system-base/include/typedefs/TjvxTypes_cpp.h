...
enum class jvxReportCommandRequest
{
	...
	JVX_REPORT_COMMAND_REQUEST_UPDATE_PROPERTIES, // IjvxReportCommandRequest
	...
	JVX_REPORT_COMMAND_REQUEST_UPDATE_PROPERTY_CONTENT, // IjvxReportCommandRequest_id
	JVX_REPORT_COMMAND_REQUEST_UPDATE_PROPERTY_DESCRIPTOR_CONTENT, // IjvxReportCommandRequest_id

	JVX_REPORT_COMMAND_REQUEST_PROPERTY_REPORT_SET, // IjvxReportCommandRequest_id
