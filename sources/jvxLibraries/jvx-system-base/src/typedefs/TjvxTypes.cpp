...
jvxComponentClassAssociation theClassAssociation[JVX_COMPONENT_ALL_LIMIT+1] =
{
	...
	{ jvxComponentTypeClass::JVX_COMPONENT_TYPE_TECHNOLOGY, JVX_COMPONENT_EXTERNAL_DEVICE,
		"External Technologies", "external", "External Devices" , jvxComponentTypeClass::JVX_COMPONENT_TYPE_DEVICE},/*JVX_COMPONENT_EXTERNAL_TECHNOLOGY*/

	/* JVX_COMPONENT_EXTERNAL_DEVICE */
	{ jvxComponentTypeClass::JVX_COMPONENT_TYPE_NONE, JVX_COMPONENT_UNKNOWN, NULL, NULL, NULL, jvxComponentTypeClass::JVX_COMPONENT_TYPE_NONE },/*JVX_COMPONENT_EXTERNAL_DEVICE*/

	/* JVX_COMPONENT_EXTERNAL_NODE */
	{ jvxComponentTypeClass::JVX_COMPONENT_TYPE_NODE, JVX_COMPONENT_UNKNOWN, "External Nodes", "external_node", NULL, jvxComponentTypeClass::JVX_COMPONENT_TYPE_NONE },/*JVX_COMPONENT_EXTERNAL_NODE*/

	/* JVX_COMPONENT_DYNAMIC_NODE */
	{ jvxComponentTypeClass::JVX_COMPONENT_TYPE_NODE, JVX_COMPONENT_UNKNOWN, "Dynamic Nodes", "dynamic_node", NULL, jvxComponentTypeClass::JVX_COMPONENT_TYPE_NONE },/*JVX_COMPONENT_DYNAMIC_NODE*/

	/* JVX_COMPONENT_PACKAGE */
	{ jvxComponentTypeClass::JVX_COMPONENT_TYPE_PACKAGE, JVX_COMPONENT_UNKNOWN, NULL, NULL, NULL, jvxComponentTypeClass::JVX_COMPONENT_TYPE_NONE }, /*JVX_COMPONENT_MIN_HOST*/
	...
	/* JVX_COMPONENT_GLOBAL_LOCK */
	{ jvxComponentTypeClass::JVX_COMPONENT_TYPE_TOOL, JVX_COMPONENT_UNKNOWN, NULL, NULL, NULL, jvxComponentTypeClass::JVX_COMPONENT_TYPE_NONE } /* JVX_COMPONENT_GLOBAL_LOCK */
