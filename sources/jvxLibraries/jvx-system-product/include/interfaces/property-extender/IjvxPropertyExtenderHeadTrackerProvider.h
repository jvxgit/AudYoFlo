...
public:
	...
	virtual jvxErrorType report_rotation_displacement(IjvxPropertyExtenderHeadTrackerProvider* origin, jvx_quat* rot_data, jvxData* center_displacement_3d, jvxSize slotId = 0, jvxSyncTimeStamp_data* tStamp = nullptr) = 0;
