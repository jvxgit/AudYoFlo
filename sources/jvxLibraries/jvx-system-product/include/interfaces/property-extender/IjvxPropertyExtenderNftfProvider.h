...
public:
	...
	virtual jvxErrorType report_position(IjvxPropertyExtenderNftfProvider* origin, jvxData* xyzPosiLeftEar_3, jvxData* xyzPosiRightEar_3, jvxData* rxryrzRotationHead_3, jvxSize idPosition = 0) = 0;
	virtual jvxErrorType report_nftf_fname(IjvxPropertyExtenderNftfProvider* origin, const char* fNameNftf, jvxSize idPosition = 0) = 0;
	virtual jvxErrorType report_quality(IjvxPropertyExtenderNftfProvider* origin, jvxRemoteConnectionQuality qual, jvxData qualValue = -1, jvxSize idPosition = 0) = 0;
};
