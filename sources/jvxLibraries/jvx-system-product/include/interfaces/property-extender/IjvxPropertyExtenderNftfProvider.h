...
public:
	...
	virtual jvxErrorType report_position(IjvxPropertyExtenderNftfProvider* origin, jvxData* xyzPosiLeftEar_3, jvxData* xyzPosiRightEar_3, jvx_quat* rot_data_rel, jvxSize slotId = 0, jvxSyncTimeStamp_data* tStamp = nullptr) = 0;
