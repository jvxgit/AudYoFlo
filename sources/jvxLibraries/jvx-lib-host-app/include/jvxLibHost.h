...
#error Libhost App without API specification is not allowed!!
	...
	jvxErrorType process_next_iterator_handle(IjvxConnectionIterator* it, IjvxConnectionIterator** next, jvxSize id, jvxApiString* nmOcon, jvxApiString* nmIcon);
	// jvxErrorType process_next_iterator_ocon_name(IjvxConnectionIterator* it, jvxApiString* nmVia, jvxSize id);
