...
#define JVX_TAG_CONNECT "socket_slave_dev"

// =============================================================
// =============================================================
// =============================================================

CjvxQtComponentWidget_socket_slave_dev::CjvxQtComponentWidget_socket_slave_dev(const char* additionalUiConfigTokens)
{
	theHostRef = NULL;
	theNetworkW = NULL;
...
CjvxQtComponentWidget_socket_slave_dev::~CjvxQtComponentWidget_socket_slave_dev()
{
}

void
CjvxQtComponentWidget_socket_slave_dev::init_submodule(IjvxHost* hostRef)
{
	theHostRef = hostRef;
	theNetworkW = NULL;
}
...
void
CjvxQtComponentWidget_socket_slave_dev::terminate_submodule()
{
}


void
CjvxQtComponentWidget_socket_slave_dev::updateWindow()
{
	widgetWrapper.trigger_updateWindow(JVX_TAG_CONNECT);
}

void
CjvxQtComponentWidget_socket_slave_dev::updateWindow_periodic()
{
	widgetWrapper.trigger_updateWindow_periodic(JVX_TAG_CONNECT);
}

void
CjvxQtComponentWidget_socket_slave_dev::start_show(IjvxAccessProperties* propRef, QFrame* placeHere, const char* propPrefix)
{
	theNetworkW = new jvxQtSaNetworkSlaveDevice(placeHere);
...
void
CjvxQtComponentWidget_socket_slave_dev::stop_show(QFrame* placeHere)
{
...
jvxErrorType
CjvxQtComponentWidget_socket_slave_dev::reportPropertySet(const char* tag, const char* propDescrptior, jvxSize groupid, jvxErrorType res_in_call)
{
	return JVX_NO_ERROR;
}

jvxErrorType
CjvxQtComponentWidget_socket_slave_dev::reportPropertyGet(const char* tag, const char* propDescrptior,
...
jvxErrorType
CjvxQtComponentWidget_socket_slave_dev::reportAllPropertiesAssociateComplete(const char* tag)
{
	return JVX_NO_ERROR;
}

jvxErrorType
CjvxQtComponentWidget_socket_slave_dev::reportPropertySpecific(jvxSaWidgetWrapperspecificReport, jvxHandle *)
{
	return JVX_NO_ERROR;
}
