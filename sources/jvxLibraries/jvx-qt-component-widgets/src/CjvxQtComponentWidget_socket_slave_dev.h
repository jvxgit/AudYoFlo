#ifndef __CJVXQTCOMPONENTWIDGET_SOCKET_SLAVE_DEV_H__
#define __CJVXQTCOMPONENTWIDGET_SOCKET_SLAVE_DEV_H__
...
class CjvxQtComponentWidget_socket_slave_dev: public QObject, public IjvxQtComponentWidget,
	public IjvxQtSaWidgetWrapper_report
{
private:
	IjvxHost* theHostRef;
	jvxQtSaNetworkSlaveDevice* theNetworkW;
	std::string addConfigToken;
	CjvxQtSaWidgetWrapper widgetWrapper;

	Q_OBJECT
public:
	CjvxQtComponentWidget_socket_slave_dev(const char* additionalUiConfigTokens = "");
	~CjvxQtComponentWidget_socket_slave_dev();
