...
class CjvxAudioDevice: public CjvxSimpleMasterDevice,
...
protected:
	...
	{		
		...
		//IjvxInputConnector* link_audio_node;
...
public:
	...
	// = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = =
	JVX_CALLINGCONVENTION CjvxAudioDevice(JVX_CONSTRUCTOR_ARGUMENTS_MACRO_DECLARE);
