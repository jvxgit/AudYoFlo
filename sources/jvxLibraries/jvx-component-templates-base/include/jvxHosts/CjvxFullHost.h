...
*/
	...
	// ====================================================================================
	jvxErrorType attach_external_component(IjvxObject* toBeAttached, jvxComponentType cpTpOrig, const char* moduleGroup, const char* registerToken, jvxBool regConnFactory, jvxBool noCfgSave, jvxSize desiredSlotId, jvxSize desiredSlotSubId) override;
