#ifndef __CJVXVIDEOTECHNOLOGY_H__
#define __CJVXVIDEOTECHNOLOGY_H__
...
class CjvxVideoTechnology: public IjvxTechnology, public CjvxTechnology,
...
public:
	...
	// = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	JVX_CALLINGCONVENTION CjvxVideoTechnology(JVX_CONSTRUCTOR_ARGUMENTS_MACRO_DECLARE);

	virtual JVX_CALLINGCONVENTION ~CjvxVideoTechnology();
