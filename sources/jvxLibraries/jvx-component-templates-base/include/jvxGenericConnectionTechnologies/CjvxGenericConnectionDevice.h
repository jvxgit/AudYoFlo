#ifndef __CJVXGENERICCONNECTIONDEVICE_H__
#define __CJVXGENERICCONNECTIONDEVICE_H__
...
#include "pcg_CjvxGenericConnectionDevice_pcg.h"

// JVX_CONNECTION_TEXTLOG_SHIFT 0 defined in CjvxGenericConnectionTextDevice.h
#define JVX_GENERIC_CONNECTION_OUTPUT_TIMING_SHIFT 1
#define JVX_GENERIC_CONNECTION_OUTPUT_UNMATCHED_SHIFT 2
#define JVX_GENERIC_CONNECTION_OUTPUT_ALLINCOMING_SHIFT 3
#define JVX_GENERIC_CONNECTION_OUTPUT_ALLOUTGOING_SHIFT 4
#define JVX_GENERIC_CONNECTION_OUTPUT_ERRORS_SHIFT 5
#define JVX_GENERIC_CONNECTION_OUTPUT_SUBMODULE_OFFSET 6
#define JVX_GENERIC_CONNECTION_OUTPUT_TIMEOUT_MESSAGES_COUT 7
#define JVX_GENERIC_CONNECTION_OUTPUT_ALL 0xFFFF
...
protected:
	...
	IjvxObject* theConnectionObj = nullptr;
	IjvxConnection* theConnectionTool = nullptr;
	jvxSize idDevice;

	jvxHandle* theObserverThread = nullptr;
	...
	jvxBool output_connection_on_stdcout;
...
public:
	...
	// = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = 
	JVX_CALLINGCONVENTION CjvxGenericConnectionDevice(JVX_CONSTRUCTOR_ARGUMENTS_MACRO_DECLARE);

	virtual JVX_CALLINGCONVENTION ~CjvxGenericConnectionDevice();
...
#include "codeFragments/simplify/jvxDevice_simplify.h"
	...
	// ========================================================================
	virtual void select_connection_specific() = 0;
	virtual void unselect_connection_specific() = 0;
	virtual jvxErrorType activate_connection_port() = 0;
	virtual jvxErrorType deactivate_connection_port() = 0;
