#ifndef __JVX_BASE_DSP_TYPES_TICCS_H__
#define __JVX_BASE_DSP_TYPES_TICCS_H__
...
JVX_STATIC_INLINE jvxInt64 JVX_GET_TICKCOUNT_US_GET(jvxTimeStampData* refData)
{
...
JVX_STATIC_INLINE jvxInt64 JVX_GET_TICKCOUNT_US_ABS()
{
    jvxUInt64 tsc_now = _itoll(TSCH, TSCL);
	return tsc_now;
}
