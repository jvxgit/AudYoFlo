...
echo cmake -G "Ninja" -DCMAKE_INSTALL_PREFIX=lib $rest -DCMAKE_BUILD_TYPE=$buildtype -DDISABLE_FORTRAN=TRUE .. -DCMAKE_POLICY_DEFAULT_CMP0057=NEW -DCMAKE_POLICY_VERSION_MINIMUM=3.10
cmake -G "Ninja" -DCMAKE_INSTALL_PREFIX=lib $rest -DCMAKE_BUILD_TYPE=$buildtype -DDISABLE_FORTRAN=TRUE .. -DCMAKE_POLICY_DEFAULT_CMP0057=NEW -DCMAKE_POLICY_VERSION_MINIMUM=3.10
echo ninja install
ninja install

echo cmake -G "Ninja" -DCMAKE_INSTALL_PREFIX=lib $rest -DCMAKE_BUILD_TYPE=$buildtype -DENABLE_FLOAT=TRUE -DDISABLE_FORTRAN=TRUE .. -DCMAKE_POLICY_DEFAULT_CMP0057=NEW -DCMAKE_POLICY_VERSION_MINIMUM=3.10
cmake -G "Ninja" -DCMAKE_INSTALL_PREFIX=lib $rest -DCMAKE_BUILD_TYPE=$buildtype -DENABLE_FLOAT=TRUE -DDISABLE_FORTRAN=TRUE .. -DCMAKE_POLICY_DEFAULT_CMP0057=NEW -DCMAKE_POLICY_VERSION_MINIMUM=3.10
echo ninja install
ninja install
