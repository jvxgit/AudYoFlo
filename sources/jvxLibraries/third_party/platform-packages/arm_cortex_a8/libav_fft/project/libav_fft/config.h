...
#define LIBAV_CONFIGURATION "--cpu=cortex-a8 --arch=arm --target-os=none --enable-cross-compile --cross-prefix=arm-none-eabi- --sysroot=/cygdrive/d/ti/ccsv6/tools/compiler/gcc-arm-none-eabi-4_9-2015q3/bin/ --sysinclude=/cygdrive/d/ti/ccsv6/tools/compiler/gcc-arm-none-eabi-4_9-2015q3/arm-none-eabi/include/ --disable-static --enable-shared --extra-cflags='--specs=rdimon.specs -mfloat-abi=hard -mfpu=neon' --extra-ldflags='--specs=rdimon.specs -mfloat-abi=hard -mfpu=neon' --extra-libs='-lrdimon -lc -lgcc' --disable-everything --disable-programs --enable-hardcoded-tables --disable-all --enable-fft --enable-rdft"
#define LIBAV_LICENSE "LGPL version 2.1 or later"
#define AVCONV_DATADIR "/usr/local/share/avconv"
#define CC_IDENT "gcc 4.9.3 (GNU Tools for ARM Embedded Processors)"
