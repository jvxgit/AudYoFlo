...
glnxexts="-DKISSFFT_DATATYPE=$dataformat -DKISSFFT_OPENMP=FALSE -DKISSFFT_PKGCONFIG=FALSE -DKISSFFT_STATIC=TRUE -DCMAKE_POSITION_INDEPENDENT_CODE=ON -DKISSFFT_TEST=FALSE -DKISSFFT_TOOLS=FALSE -DKISSFFT_USE_ALLOCA=FALSE"
