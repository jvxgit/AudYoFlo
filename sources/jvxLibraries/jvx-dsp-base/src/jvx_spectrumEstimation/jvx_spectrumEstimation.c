	...
	jvxFFTGlobal* fftGlobCfg)
{
	...
	jvx_circbuffer_allocate_global_fft_ifft(&prv->globalFFT, JVX_FFT_TOOLS_FFT_SIZE_8192, fftGlobCfg JVX_FFT_GLOBAL_CONFIG_ADD_ARGUMENT_CALL); // global init with max size
