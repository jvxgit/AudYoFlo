 ...
 *///==============================================================================
std::string
CjvxIosAudioDevice::CFString2StdString(CFStringRef& str)
{
	int i;
	UniChar sChar;
	char cChar[2] = {0,0};
                              ...
                              void* inClientData)
{
    if(inClientData)
    {
        CjvxIosAudioDevice* ptrDevice = (CjvxIosAudioDevice*)inClientData;
 ...
 *///==============================================================================
Boolean
CjvxIosAudioDevice::GetPropertyDataSize(AudioObjectID mAudioDeviceID, UInt32 inChannel,
 ...
 *///==============================================================================
Boolean
CjvxIosAudioDevice::GetPropertyData(AudioObjectID mAudioDeviceID, UInt32 inChannel,
											Boolean inSection, UInt32 inPropertyID,
 ...
 *///==============================================================================
Boolean
CjvxIosAudioDevice::GetPropertyData_AudioDeviceN(AudioDeviceID mAudioDeviceID, UInt32 inChannel,
                                                       Boolean inSection, UInt32 inPropertyID,
                                                       UInt32* ioDataSize, void* outData)
{
    AudioObjectPropertyAddress singlePropGet;
 ...
 *///==============================================================================
Boolean
CjvxIosAudioDevice::SetPropertyData_AudioDeviceN(AudioDeviceID mAudioDeviceID, UInt32 inChannel,
                                                       Boolean inSection, UInt32 inPropertyID,
                                                       UInt32 ioDataSize, void* outData)
{
    AudioObjectPropertyAddress singlePropGet;
 ...
 *///==============================================================================
Boolean
CjvxIosAudioDevice::GetPropertyData_AudioStream(AudioDeviceID mAudioStreamID, UInt32 inPropertyID, UInt32* ioDataSize, void* outData)
{
	AudioObjectPropertyAddress singlePropGet;
 ...
 *///==============================================================================
Boolean
CjvxIosAudioDevice::GetPropertyDataSize_AudioDeviceN(AudioDeviceID mAudioDeviceID, UInt32 inChannel,
														 Boolean inSection, UInt32 inPropertyID,
														 UInt32* ioDataSize)
{
	AudioObjectPropertyAddress singlePropGet;
 ...
 *///==============================================================================
Boolean
CjvxIosAudioDevice::GetPropertyDataSize_AudioStream(AudioStreamID mAudioStreamID, UInt32 inPropertyID, UInt32* ioDataSize)
{
	AudioObjectPropertyAddress singlePropGet;
 ...
 *///==============================================================================
void
CjvxIosAudioDevice::clearProperties()
{
	int i;
 ...
 *///==============================================================================
void
CjvxIosAudioDevice::clearPropertiesInit()
{
	configurationStruct.clockDomain = 0;
	configurationStruct.deviceIsAlive = 0;
	configurationStruct.deviceIsRunningElsewhere = 0;
 ...
 *///==============================================================================
void
CjvxIosAudioDevice::getClockDomain()
{
	UInt32 sz = 0;
    Boolean locRes = true;
 ...
 *///==============================================================================
void
CjvxIosAudioDevice::getDeviceAlive()
{
    UInt32 sz = 0;
    Boolean locRes = true;
 ...
 *///==============================================================================
void
CjvxIosAudioDevice::getDeviceRunningElsewhere()
{
	UInt32 sz = 0;
   Boolean locRes = true;
 ...
 *///==============================================================================
void
CjvxIosAudioDevice::getDeviceOverload()
{
	UInt32 sz = 0;
    Boolean locRes = true;
 ...
 *///==============================================================================
void
CjvxIosAudioDevice::getDeviceHogMode()
{
    UInt32 sz = 0;
    Boolean locRes = true;
 ...
 *///==============================================================================
void
CjvxIosAudioDevice::getDeviceLatencies()
{
    UInt32 sz = 0;
    Boolean locRes = true;
 ...
 //       std::cout << "kAudioDevicePropertyLatency (output) failed." << std::endl;
         ...
         *///==============================================================================
void
CjvxIosAudioDevice::getDeviceFramesize()
{
	UInt32 sz = 0;
    Boolean locRes = true;
 ...
 *///==============================================================================
jvxErrorType
CjvxIosAudioDevice::setDeviceFramesize(UInt32 fSize)
{
    UInt32 sz = 0;
    Boolean locRes = true;
	...
	return(JVX_ERROR_INVALID_SETTING);
         ...
         *///==============================================================================
void
CjvxIosAudioDevice::getDeviceFramesizesAvailable()
{
    jvxSize j;
	UInt32 sz = 0;
    Boolean locRes = true;
 ...
 *///==============================================================================
void
CjvxIosAudioDevice::getDeviceUseVarFramesize()
{
	UInt32 sz = 0;
    Boolean locRes = true;
 ...
 *///==============================================================================
void
CjvxIosAudioDevice::getDeviceStreams()
{
	int i;
	UInt32 sz = 0;
    Boolean locRes = true;
 ...
 *///==============================================================================
void
CjvxIosAudioDevice::getDeviceSafetyOffset()
{
	UInt32 sz = 0;
    Boolean locRes = true;
 ...
 *///==============================================================================
void
CjvxIosAudioDevice::getDeviceCycleUsage()
{
	UInt32 sz = 0;
    Boolean locRes = true;
 ...
 *///==============================================================================
void
CjvxIosAudioDevice::getDeviceAudioStreams()
{
	UInt32 sz = 0;
    Boolean locRes = true;
 ...
 *///==============================================================================
void
CjvxIosAudioDevice::getDeviceAudioStreamUsage()
{
	UInt32 sz = 0;
    Boolean locRes = true;
 ...
 *///==============================================================================
void
CjvxIosAudioDevice::getDeviceSamplerates()
{
	UInt32 sz = 0;
    Boolean locRes = true;
 ...
 *///==============================================================================
void
CjvxIosAudioDevice::getNominalSamplerate()
{
	UInt32 sz = 0;
    Boolean locRes = true;
 ...
 *///==============================================================================
jvxErrorType
CjvxIosAudioDevice::setNominalSamplerate(Float64 sRate)
{
	int i;
	UInt32 sz = 0;
    Boolean locRes = true;
 ...
 *///==============================================================================
void
CjvxIosAudioDevice::getActualSamplerate()
{
	UInt32 sz = 0;
    Boolean locRes = true;
 ...
 *///==============================================================================
void
CjvxIosAudioDevice::evaluateProperties()
{
	int i,ii;
    Boolean locRes = true;
 ...
 *///===========================================================
jvxErrorType
CjvxIosAudioDevice::activateCoreAudioProperties()
{
 ...
 *///===============================================================
jvxErrorType
CjvxIosAudioDevice::deactivateCoreAudioProperties()
{
	jvxErrorType res = JVX_NO_ERROR;
	int resA = 0;
	int i;
 ...
 *///==============================================================================
jvxErrorType
CjvxIosAudioDevice::prepareCoreAudio()
{
    jvxSize i;
    ...
    if(AudioDeviceCreateIOProcID(runtime.deviceProps.hdlDevice, AudioDeviceIOProcDev, (void*)this, &runtime.references.procID) == noErr)
    {
        ...
        {
            if(CjvxAudioDevice::properties_active.inputchannelselection.value.selection & ((jvxBitField)1 << i))
            {
                runtime.references.chan_map_input.push_back(i);
            }
            else
            {
        ...
        {
            if(CjvxAudioDevice::properties_active.outputchannelselection.value.selection & ((jvxBitField)1 << i))
            {
                runtime.references.chan_map_output.push_back(i);
            }
            else
            {
...
jvxErrorType
CjvxIosAudioDevice::postprocessCoreAudio()
{
 ...
 *///=========================================================
jvxErrorType
CjvxIosAudioDevice::startCoreAudio()
{
 ...
 *///=========================================================
jvxErrorType
CjvxIosAudioDevice::stopCoreAudio()
{
...
void
CjvxIosAudioDevice::process(const AudioTimeStamp* inNow, const AudioBufferList* inInputData,
    ...
    if(inInputData)
    {
        for(i = 0; i < inInputData->mNumberBuffers; i++)
        {
            ...
            for(ii = 0; ii < inInputData->mBuffers[i].mNumberChannels; ii++)
            {
                ...
                if(chanMap >= 0)
                {
                    switch(inProcessing.theData.con_params.format)
                    {
                        case JVX_DATAFORMAT_DATA:
                            ptrOut_dbl = reinterpret_cast<jvxData*>(inProcessing.theData.con_data.buffers[0][chanMap]);
                        ...
                        case JVX_DATAFORMAT_8BIT:
                            ptrOut_int8 = reinterpret_cast<jvxInt8*>(inProcessing.theData.con_data.buffers[0][chanMap]);
                            for(iii = 0; iii < _inproc.buffersize; iii++)
                            {
                                tmp = JVX_FLOAT_2_DATA(*inPtrs_interleaved);
                        ...
                        case JVX_DATAFORMAT_16BIT_LE:
                            ptrOut_int16 = reinterpret_cast<jvxInt16*>(inProcessing.theData.con_data.buffers[0][chanMap]);
                            for(iii = 0; iii < _inproc.buffersize; iii++)
                            {
                                tmp = JVX_FLOAT_2_DATA(*inPtrs_interleaved);
                        ...
                        case JVX_DATAFORMAT_32BIT_LE:
                            ptrOut_int32 = reinterpret_cast<jvxInt32*>(inProcessing.theData.con_data.buffers[0][chanMap]);
                            for(iii = 0; iii < _inproc.buffersize; iii++)
                            {
                                tmp = JVX_FLOAT_2_DATA(*inPtrs_interleaved);
                        ...
                        case JVX_DATAFORMAT_64BIT_LE:
                            ptrOut_int64 = reinterpret_cast<jvxInt64*>(inProcessing.theData.con_data.buffers[0][chanMap]);
                            for(iii = 0; iii < _inproc.buffersize; iii++)
                            {
                                tmp = JVX_FLOAT_2_DATA(*inPtrs_interleaved);
    ...
    if(outOutputData)
    {
        for(i = 0; i < outOutputData->mNumberBuffers; i++)
        {
            ...
            for(ii = 0; ii < outOutputData->mBuffers[i].mNumberChannels; ii++)
            {
                ...
                if(chanMap >= 0)
                {
                    switch(inProcessing.theData.con_compat.format)
                    {
                        case JVX_DATAFORMAT_DATA:
                            ptrIn_dbl = reinterpret_cast<jvxData*>(inProcessing.theData.con_compat.from_receiver_buffer_allocated_by_sender[0][chanMap]);
                            for(iii = 0; iii < _inproc.buffersize; iii++)
                            {
                        ...
                        case JVX_DATAFORMAT_8BIT:
                            ptrIn_int8 = reinterpret_cast<jvxInt8*>(inProcessing.theData.con_compat.from_receiver_buffer_allocated_by_sender[0][chanMap]);
                            for(iii = 0; iii < _inproc.buffersize; iii++)
                            {
                            ...
                            break;
                        case JVX_DATAFORMAT_16BIT_LE:
                            ptrIn_int16 = reinterpret_cast<jvxInt16*>(inProcessing.theData.con_compat.from_receiver_buffer_allocated_by_sender[0][chanMap]);
                            for(iii = 0; iii < _inproc.buffersize; iii++)
                            {
                            ...
                            break;
                        case JVX_DATAFORMAT_32BIT_LE:
                            ptrIn_int32 = reinterpret_cast<jvxInt32*>(inProcessing.theData.con_compat.from_receiver_buffer_allocated_by_sender[0][chanMap]);
                            for(iii = 0; iii < _inproc.buffersize; iii++)
                            {
                            ...
                            break;
                        case JVX_DATAFORMAT_64BIT_LE:
                            ptrIn_int64 = reinterpret_cast<jvxInt64*>(inProcessing.theData.con_compat.from_receiver_buffer_allocated_by_sender[0][chanMap]);
                            for(iii = 0; iii < _inproc.buffersize; iii++)
                            {
