...
enum class jvxAudioFileWriteFiletype
{
...
class CjvxAudioFileWriterDevice :
	public CjvxAudioDevice,
    public genFileWriter_device
{
	friend class CjvxAudioFileWriterTechnology;

	enum class jvxAudioFileWriterBufferStatus
	{
...
private:
	...
	CjvxAudioFileWriterTechnology* parentTech = nullptr;
...
public:
	JVX_CALLINGCONVENTION CjvxAudioFileWriterDevice(JVX_CONSTRUCTOR_ARGUMENTS_MACRO_DECLARE);
	virtual JVX_CALLINGCONVENTION ~CjvxAudioFileWriterDevice();
