...
jvxErrorType 
CjvxNetworkMasterDevice::st_callback_message_queue_started(jvxHandle* privateData, jvxInt64 timestamp_us)
{
	if(privateData)
	{
...
jvxErrorType 
CjvxNetworkMasterDevice::st_callback_message_queue_message_in_queue_ready(jvxSize contextId, jvxHandle* fld, jvxSize szFld, jvxHandle* privateData_queue, jvxHandle* privateData_message, jvxInt64 timestamp_us)
{
	if(privateData_queue)
	{
		CjvxNetworkMasterDevice* this_ptr = reinterpret_cast<CjvxNetworkMasterDevice*>(privateData_queue);
...
jvxErrorType 
CjvxNetworkMasterDevice::st_callback_message_queue_stopped(jvxHandle* privateData_queue, jvxInt64 timestamp_us)
{
	if(privateData_queue)
	{
		CjvxNetworkMasterDevice* this_ptr = reinterpret_cast<CjvxNetworkMasterDevice*>(privateData_queue);
...
jvxErrorType 
CjvxNetworkMasterDevice::st_callback_message_queue_message_in_queue_timeout(jvxSize contextId, jvxHandle* fld, jvxSize szFld, jvxHandle* privateData_queue, jvxHandle* privateData_message, jvxInt64 timestamp_us)
{
	if(privateData_queue)
	{
		CjvxNetworkMasterDevice* this_ptr = reinterpret_cast<CjvxNetworkMasterDevice*>(privateData_queue);
...
// ==========================================================================================================
jvxErrorType 
CjvxNetworkMasterDevice::ic_callback_message_queue_started(jvxInt64 timestamp_us)
{
	return(JVX_ERROR_UNSUPPORTED);
}
jvxErrorType 
CjvxNetworkMasterDevice::ic_callback_message_queue_message_in_queue_ready(jvxSize contextId, jvxHandle* fld, jvxSize szFld,  jvxHandle* privateData_message, jvxInt64 timestamp_us)
{
...
#endif
			res = jvx_connect_client_send_st(this->socketClientIf, (char*)fld, &szFld, NULL, JVX_CONNECT_PRIVATE_ARG_TYPE_NONE);
...
jvxErrorType 
CjvxNetworkMasterDevice::ic_callback_message_queue_stopped(jvxInt64 timestamp_us)
{
	return(JVX_NO_ERROR);
}
	
jvxErrorType 
CjvxNetworkMasterDevice::ic_callback_message_queue_message_in_queue_timeout(jvxSize contextId, jvxHandle* fld, jvxSize szFld, jvxHandle* privateData_message, jvxInt64 timestamp_us)
{
	assert(0);
	return(JVX_NO_ERROR);
}	
