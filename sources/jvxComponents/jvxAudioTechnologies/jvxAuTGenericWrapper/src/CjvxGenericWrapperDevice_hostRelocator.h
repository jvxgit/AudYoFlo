...
public:
	...
	virtual jvxErrorType outputs_data_format_group(jvxDataFormatGroup grp)override;
	virtual jvxErrorType accepts_data_format_group(jvxDataFormatGroup grp)override;
