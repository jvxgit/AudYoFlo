...
class CjvxAudioFileReaderTechnology : 
	public CjvxTemplateTechnologyVD<CjvxAudioFileReaderDevice>,
...
private:
	...
	std::map<IjvxDevice*, CjvxAudioFileReaderDevice*> lstDevType;

	std::list<std::string> fNamesOnConfig;
	std::string selectedFile;
public:

	JVX_CALLINGCONVENTION CjvxAudioFileReaderTechnology(JVX_CONSTRUCTOR_ARGUMENTS_MACRO_DECLARE);
	JVX_CALLINGCONVENTION ~CjvxAudioFileReaderTechnology();
...
#define JVX_INTERFACE_SUPPORT_BASE_CLASS CjvxTemplateTechnologyVD<CjvxAudioFileReaderDevice>
...
#undef JVX_INTERFACE_SUPPORT_PROPERTIES
	...
	void trigger_close_file_core(std::pair<IjvxDevice*, CjvxAudioFileReaderDevice*> elm);
};
