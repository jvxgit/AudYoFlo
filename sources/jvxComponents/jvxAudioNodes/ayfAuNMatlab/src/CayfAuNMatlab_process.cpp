...
CayfAuNMatlab::prepare_connect_icon(JVX_CONNECTION_FEEDBACK_TYPE(fdb))
{
	...
	CjvxMexCalls::prepare_sender_to_receiver(_common_set_ldslave.theData_in);
#endif
	...
	if (res == JVX_NO_ERROR)
	{
		CjvxMexCalls::prepare_complete_receiver_to_sender(_common_set_ldslave.theData_in, &_common_set_ldslave.theData_out);
	}
	else
	{
		CjvxMexCalls::postprocess_sender_to_receiver(_common_set_ldslave.theData_in);
	}
#endif
	return res;
...
#ifdef JVX_EXTERNAL_CALL_ENABLED
	CjvxMexCalls::before_postprocess_receiver_to_sender(_common_set_ldslave.theData_in);
#endif
...
CayfAuNMatlab::process_buffers_icon(jvxSize mt_mask, jvxSize idx_stage)
{
	...
	if (isPresent && engaged)
	{
		...
		// ======================================================================================
		res = CjvxMexCalls::process_buffers_icon(_common_set_ldslave.theData_in, &_common_set_ldslave.theData_out);
		// ======================================================================================
