/*
  ===========================================================================
   File: TYPEDEFS.H                                      v.2.0 - 15.Nov.2004
  ===========================================================================
 ...
 *        jvxData         floating point    minjvxData,   maxjvxData
 *
 *
 ...
 */
/* use "if 0" below if jvxData should be double;
   use "if 1" below if jvxData should be float
 */
